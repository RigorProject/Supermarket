			...
			<table  class="table">
				...
				<c:forEach items="${suppliers}" var="supplier">
					<tr bgcolor="#E1E1E1">
						...
						<td><a href="<c:url value='editSupplier.htm?id=${supplier.supplierName}'/>"> <button id="editSupplier" name="editSupplier" class="btn btn-success">Edit</button></a>
							<a href="<c:url value='deleteSupplier.htm?id=${supplier.supplierName}'/>"><button id="deleteSupplier" name="deleteSupplier" class="btn btn-danger">Delete</button></a>
							</td>
					</tr>
